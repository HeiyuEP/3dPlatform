...
void DIBRParamInit() {
	printf("[INFO] DIRB: Param Init.\n");
	getEnvOrDefault(&dibrBin, "DIBR_BIN", "/home/zhike/3DPlatformDep/openDibr/bin/RealtimeDIBR");
	getEnvOrDefault(&sunshineAssetDir, "SUNSHINE_ASSET_DIR", "/home/zhike/3DPlatformDep/openDibr/asset/");
	getEnvOrDefault(&dibr1kOutputJsonPath, "DIBR_1K_OUPUT_JSON_PATH", "/home/zhike/3DPlatformDep/openDibr/asset/example_opengl_1k.json");
	getEnvOrDefault(&dibr2kOutputJsonPath, "DIBR_2K_OUPUT_JSON_PATH", "/home/zhike/3DPlatformDep/openDibr/asset/example_opengl_2k.json");
	getEnvOrDefault(&dibrLeftOMAF1kInputJson, "DIBR_LEFT_OMAF_1K_INPUT_JSON", "/home/zhike/3DPlatformDep/openDibr/asset/left_omaf_1k.json");
	getEnvOrDefault(&dibrLeftOMAF2kInputJson, "DIBR_LEFT_OMAF_2K_INPUT_JSON", "/home/zhike/3DPlatformDep/openDibr/asset/left_omaf_2k.json");
	getEnvOrDefault(&dibrRightOmaf1kInputJson, "DIBR_RIGHT_OMAF_1K_INPUT_JSON", "/home/zhike/3DPlatformDep/openDibr/asset/right_omaf_1k.json");
	getEnvOrDefault(&dibrRightOmaf2kInputJson, "DIBR_RIGHT_OMAF_2K_INPUT_JSON", "/home/zhike/3DPlatformDep/openDibr/asset/right_omaf_2k.json");
	printf("[INFO] DIRB: Param init success.\n");
}

int DIBRFirstInit(bool outputLeft) {
	printf("[INFO] DIBR: First init.\n");
	DIBRParamInit();
...
int DIBRBInitGLTotal(PCApplication *pMainApplication, uint8_t* colorData, uint8_t* depthData) {
	printf("[INFO] DIBR: BInitGL total.\n");
...
int DIBRBInitGLTexture(PCApplication *pMainApplication, uint8_t* colorData, uint8_t* depthData) {
	printf("[INFO] DIBR: BInitGL texture.\n");
	if (colorData == nullptr || depthData == nullptr) {
		std::cout << "[ERROR] colorData or depthData is null." << std::endl;
		return 1;	
	}
