...
# huawei libsecurec
set(SECUREC_DIR "SECUREC_DIR")
if(NOT $ENV{SECUREC_DIR} STREQUAL "")
    message(STATUS "SECUREC_DIR:$ENV{SECUREC_DIR}")
    include_directories($ENV{SECUREC_DIR}/include)
    link_directories($ENV{SECUREC_DIR}/lib)
    link_libraries(boundscheck)
else()
    message(FATAL_ERROR "${SECUREC_DIR} not found")
endif()

# libtorch
set(TORCH_ROOT "TORCH_ROOT")
if(NOT $ENV{TORCH_ROOT} STREQUAL "")
    message(STATUS "TORCH_ROOT:$ENV{TORCH_ROOT}")
    include_directories($ENV{TORCH_ROOT}/include)
    link_directories($ENV{TORCH_ROOT}/lib)
else()
    message(FATAL_ERROR "${TORCH_ROOT} not found")
endif()

# depth
set(DEPTH_ROOT "DEPTH_ROOT")
if(NOT $ENV{DEPTH_ROOT} STREQUAL "")
    message(STATUS "DEPTH_ROOT:$ENV{DEPTH_ROOT}")
    include_directories($ENV{DEPTH_ROOT}/include)
    link_directories($ENV{DEPTH_ROOT}/lib)
    link_libraries(depth)
else()
    message(FATAL_ERROR "${DEPTH_ROOT} not found")
endif()

# open-dibr
if(NOT $ENV{DIBR_ROOT} STREQUAL "")
    message(STATUS "DIBR_ROOT:$ENV{DIBR_ROOT}")
    link_directories($ENV{DIBR_ROOT}/lib)
    link_libraries(RealtimeDIBR3dPlatform)
else()
    message(FATAL_ERROR "${DIBR_ROOT} not found")
endif()
