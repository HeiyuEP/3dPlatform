...
#find_library(ONNXRUNTIME_LIB onnxruntime ${ONNXRUNTIME_DIR})
set(ONNXRUNTIME_ROOT "/home/zhike/公共的/x30032372/onnxruntime-linux-x64-gpu-1.16.3")
include_directories(ORT ${ONNXRUNTIME_ROOT}/include)
link_directories(ORT ${ONNXRUNTIME_ROOT}/lib)
link_libraries(onnxruntime)

#libtorch
#set(Torch_DIR /home/zhike/公共的/x30032372/libtorch/share/cmake/Torch)
#find_package(Torch REQUIRED)
set(TORCH_ROOT "/home/zhike/公共的/x30032372/libtorch")
include_directories(${TORCH_ROOT}/include)
link_directories(${TORCH_ROOT}/lib)
#depth
include_directories(/home/zhike/公共的/x30032372/Depth-Anything-V2/cpp/pt/include)
link_directories(/home/zhike/公共的/x30032372/Depth-Anything-V2/cpp/pt/lib)
link_libraries(depth)

link_directories(
    /home/zhike/公共的/c30041999/code/open-dibr/bin
)
# link_libraries(RealtimeDIBR)
link_libraries(RealtimeDIBRCyf)
